...
{
    var _S1 : pixelOutput_0 = pixelOutput_0( vec4<f32>(tony_mc_mapface_0((textureSample((hdr_0), (non_filtering_sampler_0), (psIn_0.Uv_0)).xyz) / vec3<f32>(f32(globalParams_0.accumulated_frame_index_0 + u32(1)))), 1.0f) );
    return _S1;
}
